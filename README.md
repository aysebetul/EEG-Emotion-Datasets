...
9. [AMIGOSDataset](https://www.eecs.qmul.ac.uk/mmv/datasets/amigos/index.html) \
   ...
   **Stimuli:** 16 short videos and 4 long videos. 2 experiments: In the first one 40 participants watched 16 short emotional videos and in the second experiment, participants watched 4 long videos (some of them alone and rest in groups) Stimulus are annotated on valence and arousal dimension. \
